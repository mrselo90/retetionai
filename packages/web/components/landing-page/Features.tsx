        ...
        <section className="py-20 sm:py-24 px-6" style={{ background: '#0A3D2E' }}>
            <div className="max-w-[1100px] mx-auto">
                <div className="text-center mb-14 sm:mb-16">
                    ...
                    <p className="text-[1.05rem] max-w-[32rem] mx-auto opacity-85" style={{ color: '#F8F5E6' }}>{t('subtitle')}</p>
                </div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                    {featureConfig.map((f) => {
                        ...
                        return (
                            <div
                                key={f.key}
                                className="rounded-xl border border-[#F8F5E6]/15 bg-white/[0.04] p-6 transition-colors hover:border-[#F8F5E6]/25"
                            >
                                <div
                                ...
                                <h3 className="font-bold text-[1.05rem] mb-2" style={{ color: '#F8F5E6' }}>{t(f.key)}</h3>
                                <p className="text-sm leading-relaxed mb-4 opacity-85" style={{ color: '#F8F5E6' }}>{t(f.descKey)}</p>
                                <div className="border-t border-[#F8F5E6]/10 pt-4 flex flex-wrap gap-1.5">
