...
function Hero() {
  return (
    <section className="lsection" style={{ paddingTop: 80, paddingBottom: 80, borderBottom: 'none', overflow: 'visible' }}>
      <div className="lcontainer" style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 64, alignItems: 'center' }}>
        <div>
...
function ProofBar() {
  return (
    <section style={{ padding: '40px 0', borderBottom: '1px solid var(--lline)', borderTop: '1px solid var(--lline)' }}>
      <div className="lcontainer" style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 48, alignItems: 'center' }}>
  ...
  return (
    <section id="roi" className="lsection">
      <div className="lcontainer">
        ...
        <div style={{ border: '1px solid var(--lline)', borderRadius: 14, background: 'var(--lbg)', display: 'grid', gridTemplateColumns: '1.1fr 1fr', marginTop: 48, overflow: 'hidden' }}>
  ...
  return (
    <section id="faq" className="lsection">
      <div className="lcontainer">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: 64, marginTop: 16 }}>
          <div>
