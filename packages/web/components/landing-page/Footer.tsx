            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-10 sm:mb-12">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <p className="text-xs sm:text-sm leading-relaxed max-w-[220px] text-zinc-600">{t('tagline')}</p>
                ...
                <div className="border-t border-black/5 pt-4 sm:pt-6 flex flex-col sm:flex-row flex-wrap justify-between items-center gap-3 text-center sm:text-left">
