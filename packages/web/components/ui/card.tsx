...
>(({ className, hover = false, ...props }, ref) => (
    <div
        ...
        className={cn(
            ...
            "shadow-none",
            hover && "transition-colors duration-150 hover:border-primary/30",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <h3
        ...
        className={cn(
            ...
            "text-[length:var(--polaris-heading-md)]",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <p
        ref={ref}
        className={cn(
            "text-[length:var(--polaris-body-md)] leading-normal text-muted-foreground mt-1",
            className
        )}
        {...props}
    />
