...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const looksLikeShopifyEntry = !!shop || !!host || embedded === '1' || Boolean(idToken);

    if (!looksLikeShopifyEntry || typeof window === 'undefined') return;

    const shellBase = process.env.NEXT_PUBLIC_SHOPIFY_SHELL_URL || 'https://shop.recete.co.uk';
        ...
        >
          <div>
            ...
            >
              {t('headline1')}
              <br />
              <span style={{ opacity: 0.55 }}>{t('headline2')}</span>
            </h2>
          </div>
      ...
      >
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={{ fontSize: 14, color: 'var(--link-3)', margin: 0 }}>{t('description')}</p>
          </div>
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              <label
                style={{ fontSize: 13, fontWeight: 500, color: 'var(--link-2)' }}
                htmlFor="email"
              >
                {t('emailLabel')}
              </label>
              <input
                ...
                onFocus={(e) => {
                  ...
                  e.target.style.boxShadow = '0 0 0 3px oklch(0.42 0.07 160 / 0.1)';
                }}
                onBlur={(e) => {
                  e.target.style.borderColor = 'var(--lline-2)';
          ...
          <p style={{ textAlign: 'center', fontSize: 13.5, color: 'var(--link-3)', marginTop: 28 }}>
            ...
            <I18nLink
              href="/signup"
              style={{ color: 'var(--laccent-ink)', fontWeight: 500, textDecoration: 'none' }}
            >
              {t('register')}
            </I18nLink>
          </p>
